...
export const signUp = (bodyParams: SignUpBodyParams) =>
  axiosInstance.post(apiUserUrls.signUp(), bodyParams).then((res) => res.data);
...
export const checkNickname = ({ nickname }: CheckNicknameBodyParams) =>
  axiosInstance.get(apiUserUrls.checkNickname()).then((res) => res.data);
...
export const confirmEmail = ({ code }: ConfirmEmailBodyParams) =>
  axiosInstance.get(apiUserUrls.confirmEmail()).then((res) => res.data);
...
export const findPassword = ({ email }: FindPasswordBodyParams) =>
  axiosInstance.post(apiUserUrls.findPassword(), email).then((res) => res.data);
